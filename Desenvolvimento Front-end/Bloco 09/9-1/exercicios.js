...
sendMarsTemperature(getMarsTemperature(), temperatureInFahrenheit); */ 
...
const sendMarsTemperature = (callback, error) => {
  ...
  setTimeout(() => {
      if(messageSuccessfullySent) callback(currTemperature);
...
const teste = (error, message) => {
  if (error) console.log(error);
  console.log(message);
}
const arrowFunction = (e) => e.name === 'Bulbasaur';
